...
//{"buttonId": `${prefix}dashboard`,"buttonText": {"displayText": `ᴅᴀsʜʙᴏᴀʀᴅ`},"type": "RESPONSE"},
 // {"buttonId": `${prefix}sc`,"buttonText": {"displayText": `Script Botz`},"type": "RESPONSE"},
]
...
case 'ai':
	...
	case 'search': {
		...
		axios.get(encodeURI(`https://api.lolhuman.xyz/api/openai?apikey=${apikey}&text=${q}&user=user-unique-id`)).then(({
			data
		}) => {
